...
set :application, "rails-vue-ts-skeleton"
set :repo_url, "git@github.com:kakerukasai/rails-vue-ts-skeleton.git"
...
set :rvm_type, :user
set :rvm_ruby_version, 'ruby-2.6.0@rails-vue-ts-skeleton'
set :pty, true
